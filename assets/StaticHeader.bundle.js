...
var LiveSearch = __webpack_require__(31);
...
function () {
  function StaticHeader(section) {
    ...
    for (var i = 0; i < meganavMenus.length; i++) {
      this.megaNavs[meganavMenus[i].getAttribute('data-meganav-id')] = meganavMenus[i];
    }
  ...
  StaticHeader_createClass(StaticHeader, [{
    ...
    value: function onSectionBlockSelect(block) {
      ...
      if (this.megaNavs[block.id]) {
        this.megaNavs[block.id].classList.add('meganav-editing-block');
        this.stickyHeader.openNavigation();
      }
    }
  }, {
    ...
    value: function onSectionBlockDeselect(block) {
      if (this.megaNavs[block.id]) {
        this.megaNavs[block.id].classList.remove('meganav-editing-block');
      }
    }
  }, {
    key: "_converter",
    ...
    value: function _closeAllNavigation() {
      ...
      for (var i = 0; keys.length < i; i++) {
        this.megaNavs[keys[i]].classList.remove('meganav-editing-block');
      }
    }
  }]);
...
//# sourceMappingURL=StaticHeader.bundle.js.map?1574118071226