...
function wnwInsertAfter(newNode, referenceNode) {
...
function w3_load_js_uri(static_script) {
	...
	wnwInsertAfter(ext_js_element, static_script);
...
function wnwAnalytics() {
	...
	script2.forEach(function(analyticsScript) {
		...
		wnwInsertAfter(s, analyticsScript);
...
function wnwBoomerang() {
	...
	script2.forEach(function(boomerangScript) {
		...
		wnwInsertAfter(s, boomerangScript);
